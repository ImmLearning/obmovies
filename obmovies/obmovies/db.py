"""
This module contains all database interfacing methods for the obmovies
...
def get_db():
    ...
    MOVIES_DB_URI = current_app.config["MOVIES_DB_URI"]
    MOVIES_DB_NAME = current_app.config["MOVIES_NS"]
    if db is None:
...
def build_query_sort_project(filters):
    ...
    # to display on the front page of obmovies, because they are famous or
